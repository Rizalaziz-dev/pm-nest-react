-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'PM', 'REQUESTER', 'PRODUCTION_LEAD', 'OPERATOR_BREAKDOWN', 'ENGINEER_JOINT', 'ENGINEER_HOUSING', 'ENGINEER_JIG', 'ENGINEER_VISUAL', 'ENGINEER_JS_ACC', 'ENGINEER_JS_FIN');
...
-- CreateEnum
CREATE TYPE "ProcessName" AS ENUM ('BREAKDOWN', 'JOINT_DRAWING', 'HOUSING_DRAWING', 'JIG_DRAWING', 'VISUAL_DRAWING', 'JOB_STATION_ACC', 'JOB_STATION_FINISHING');

-- CreateEnum
CREATE TYPE "ProductionStage" AS ENUM ('PLANNING', 'PP', 'HOUSING', 'ASSEMBLING', 'JS_ACC', 'VISUAL', 'CHECKER', 'JS_FINISHING', 'PREDEL');

-- CreateEnum
CREATE TYPE "WorkOrderStatus" AS ENUM ('LOCKED', 'PENDING', 'IN_PROGRESS', 'COMPLETED', 'BLOCKED', 'REWORK');
...
CREATE TABLE "users" (
    ...
    "role" "UserRole" NOT NULL DEFAULT 'OPERATOR_BREAKDOWN',
...
CREATE TABLE "projects" (
    ...
    "scope" "ProjectScope" NOT NULL DEFAULT 'NEW_ASSY',
    "breakdownDays" INTEGER NOT NULL DEFAULT 5,
    ...
    "breakdownFinishDate" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "pmId" TEXT NOT NULL,
...
CREATE TABLE "work_orders" (
    ...
    "status" "WorkOrderStatus" NOT NULL DEFAULT 'LOCKED',
