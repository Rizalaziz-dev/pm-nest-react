...
export const dashboardApi = {
  ...
  // NEW: Complete a job
  completeJob: async (workOrderId: string): Promise<void> => {
    return aptFetch<void>(`/projects/work-order/${workOrderId}/complete`, {
      method: 'PATCH',
      // No body needed for completion, unless you want to log notes later
    });
  },
}